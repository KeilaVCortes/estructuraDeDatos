...
protected:
    ...
    /* Clase Iterator */
    class Iterator {
        const DoubleLinkedListMia<T> * _data;
        int _position;
        
    public:
        Iterator( const DoubleLinkedListMia<T> * _adata, int _aposition)
...
public:
    ...
    friend std::ostream & operator <<(std::ostream &, const DoubleLinkedListMia<Tn> &);
...
template  <class T>
DoubleLinkedListMia<T>::~DoubleLinkedListMia()
{
    this->clear();
}

template  <class T>
Node<T> * DoubleLinkedListMia<T>::first() const
{
    return this->_first;
}

template  <class T>
int DoubleLinkedListMia<T>::size() const
{
    return this->_size;
}

template  <class T>
bool DoubleLinkedListMia<T>::empty() const
{
    return this->_size == 0;
}
 ...
 */
template  <class T>
void DoubleLinkedListMia<T>::insert(const T & element, int position)
{
...
template  <class T>
void DoubleLinkedListMia<T>::insertFront(const T & element)
{
    this->insert(element, 0);
}

template  <class T>
void DoubleLinkedListMia<T>::insertFront(Node<T> * node)
{
    this->insert(node, 0);
}

template  <class T>
void DoubleLinkedListMia<T>::insertBack(const T & element)
{
    this->insert(element, this->_size);
}

template  <class T>
void DoubleLinkedListMia<T>::insertBack(Node<T> * node)
{
    this->insert(node, this->_size);
}

template  <class T>
Node<T> * DoubleLinkedListMia<T>::remove(int position)
{
    ...
    /* Eliminar cualquier otro nodo */
        ...
        removenode->getNext()->setPrev(prev);
    }
...
template  <class T>
Node<T> *  DoubleLinkedListMia<T>::removeFront()
{
    return this->remove(0);
}

template  <class T>
Node<T> *  DoubleLinkedListMia<T>::removeBack()
{
    return this->remove(this->_size - 1);
}

template  <class T>
Node<T> *  DoubleLinkedListMia<T>::remove(Node<T> * node)
{
    return this->remove( this->at(node) );
}

template  <class T>
void DoubleLinkedListMia<T>::clear()
{
...
template  <class T>
Node<T> *  DoubleLinkedListMia<T>::at(int position) const
{
    /* Cuando la lista está vacía o position es inválida */
    if (this->empty() || (position < 0 || position >= this->_size )) {
        return nullptr;
...
template  <class T>
int DoubleLinkedListMia<T>::at(Node<T> * node) const
{
...
template <class T>
std::ostream & operator <<(std::ostream & os, const DoubleLinkedListMia<T> & list)
{
...
template  <class T>
Node<T> * DoubleLinkedListMia<T>::operator [](const int position)
{
    return this->at(position);
}

template  <class T>
bool DoubleLinkedListMia<T>::search(const T & element) const
{
    return ( this->searchAndReturnPosition(element) != -1 );
}

template  <class T>
int DoubleLinkedListMia<T>::searchAndReturnPosition(const T & element) const
{
    /* Cuando la lista está vacía */
...
template  <class T>
Node<T> * DoubleLinkedListMia<T>::searchAndReturnNode(const T & element) const
{
    /* Cuando la lista está vacía */
