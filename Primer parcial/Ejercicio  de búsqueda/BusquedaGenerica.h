...
public:
    ...
    static int busquedaSecuencialPosicion(T [], int, string, bool(*) (T, string));
...
template <typename T>
int BusquedaGenerica<T>::busquedaSecuencialPosicion(T v[], int longitud, string placa, bool compara(T dato, string placa)){
    int existe = -1;
    int indice = 0;
